...
extension LocalizedStringResource {
    ...
    ///
    /// Extraction depends on the literal's type, so copy that travels through a `String`
    /// variable never reaches the catalog: type such properties and parameters as
    /// `LocalizedStringResource` too.
    ///
